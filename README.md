# PrintSmith — Sample Bootstrap Site
...
- `assets/img/` — image folder containing placeholder images (`printsmithlogo.png`, `placeholder-hero.png`).
...
```powershell
cd 'D:/PrintSmith/Websites/PS-website'
