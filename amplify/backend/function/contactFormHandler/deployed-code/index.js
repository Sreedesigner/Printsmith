...
exports.handler = async (event) => {
    ...
    try {
        ...
        console.log('Phone field value:', body.phone);
        console.log('Phone field type:', typeof body.phone);
        ...
        // Email parameters
        const params = {
            Source: 'contact@printsmith.ie', // Must be verified in SES
            Destination: {
                ToAddresses: ['contact@printsmith.ie'] // Your Outlook email
            },
            Message: {
                Subject: {
                ...
                Body: {
                        ...
                        Data: `
                            ...
                            <body>
                                <div class="container">
                                    ...
                                    <div class="footer">
                                        <p>This message was sent from the PrintSmith contact form at ${new Date().toLocaleString('en-IE', { timeZone: 'Europe/Dublin' })}</p>
                                    </div>
                                </div>
                            </body>
                            </html>
                    ...
                    Text: {
                        Data: `
New Contact Form Submission - PrintSmith
...
---
Sent from PrintSmith website contact form
